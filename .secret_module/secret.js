...
// ---------------------------------------------------------------
const ALLOWED_IPS = [
  "YOUR_IP_ADDRESS_HERE",  // ← Вставте свій IP (рядком, напр. "93.170.12.55")
  //  Як дізнатись свій IP: відкрий https://api.ipify.org у браузері
  //  Можна додати кілька IP через кому:
  //  "93.170.12.55",
  //  "192.168.1.100",
];

//  Де знаходиться твоя гіфка:
const GIF_URL = "YOUR_GIF_URL_HERE";
//  ↑ Вставте пряме посилання на гіфку (напр. "https://i.imgur.com/xxxxx.gif")
//    Посилання має вести на сам файл, а не на сторінку з гіфкою.
// ---------------------------------------------------------------
